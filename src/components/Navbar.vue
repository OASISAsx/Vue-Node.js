<template>
  <nav class="sticky bg-gray-600 border-gray-200 dark:bg-gray-500">
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-default">
        ...
        >
          ...
          <li>
            ...
            <a-button v-else type="danger" @click="logout">
              Logout
            </a-button>
          </li>
        </ul>
...
export default {
  data() {
    return {
      isLoggedIn: !!localStorage.getItem('authtoken'), // ตรวจสอบ token
    };
  },
  watch: {
    isLoggedIn(newValue) {
